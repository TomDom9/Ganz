...
def selectDie(chosenDie, position):
    ...
    if chosenDie == "Y":
        ...
        activeDice[chosenDie].currentScore = activeDice["B"].score[position.get()]
        activeDice[chosenDie].checkVal.pop(activeDice["B"].value + activeDice["W"].value)
...
diceCheck = [[3, 6, 5, 2, 1, 5, 1, 2, 4, 3, 4, 6],
             {2: None, 3: None, 4: None, 5: None, 6: None, 7: None, 8: None, 9: None, 10: None, 11: None, 12: None},
